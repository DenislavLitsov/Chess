namespace FrontEndEngine.Chess.Classes.Figures.ClassicFigures
{
    ...
    {
        public Queen(byte color, int damage, int maxHealth, string skinPack, Point pos) : base(color, damage, maxHealth, "Queen", skinPack, pos)
        {
            ...
            strategies.Add(new Strategy(0, 1, 0, 9999, 0, 0, true, kingCond));
            strategies.Add(new Strategy(1, 0, 9999, 0, 0, 0, true, kingCond));
            strategies.Add(new Strategy(-1, 0, 9999, 0, 0, 0, true, kingCond));
            strategies.Add(new Strategy(0, -1, 0, 9999, 0, 0, true, kingCond));
